      ...
      <div className="navbar-container">
        <div className="nav-links">
          <ul>
            ...
            <a href="#skills">
              <li className="animate__animated animate__fadeInUp">
                <span className="index-no">01.</span>&nbsp;Skills
              </li>
            </a>
            <a href="#projects">
              <li className="animate__animated animate__fadeInUp">
                <span className="index-no">02.</span>&nbsp;Projects
              </li>
            </a>
            <a href="#education">
              <li className="animate__animated animate__fadeInUp">
                <span className="index-no">03.</span>&nbsp;Education & Experience
              </li>
            </a>
            <a href="#contact">
              <li className="animate__animated animate__fadeInUp">
                <span className="index-no">04.</span>&nbsp;Contact
              </li>
            </a>
            <a
